...
INSERT INTO users (email, first_name, last_name, username, password, phone_number) VALUES ('user2@p.pl', 'username2', 'usersurname2', 'user2', '$2a$12$aQa1H5e.cUndJSPVcsAhsu0NtjMHcWLRfIdLLP4Bn0ujQ8t1rSMey', 111222333);
